...
/**
 * BandMemberCard component props
 */
interface BandMemberCardProps {
  /**
   * Band member data to display
   */
  member: BandMember;
}

/**
 * BandMemberCard component displays a band member with photo and info
 *
 * @example
 * ```tsx
 * <BandMemberCard member={memberData} />
 * ```
 */
  ...
  return (
    <article className={styles.memberCard}>
      ...
      <div className={styles.info}>
        ...
        {member.instrument && (
          <p className={styles.instrument}>{member.instrument}</p>
        )}
